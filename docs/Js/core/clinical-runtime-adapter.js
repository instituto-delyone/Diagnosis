...
(function (global) {
    ...
    if (typeof global.ClinicalInterlocutor === "function") {
        ...
        global.ClinicalInterlocutor.prototype.readPatientValue = function (target) {
            ...
            const maps = {
                heart_rate: ["heart_rate", "heartRate", "fc"],
                respiratory_rate: ["respiratory_rate", "respiratoryRate", "fr"],
                spo2: ["oxygen_saturation", "oxygenSaturation", "spo2", "SpO2"],
                blood_pressure: ["blood_pressure", "bloodPressure", "pa"],
        ...
        global.ClinicalInterlocutor.prototype.findInvestigation = function (target) {
            ...
            const aliases = {
                ecg: ["ecg"], blood_gas: ["blood_gas"], hemogram: ["hemogram", "hemograma"],
                laboratory: ["laboratory"], ct: ["ct", "tc"], chest_xray: ["chest_xray"]
            };
